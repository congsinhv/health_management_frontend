...
const Header = ({ className }: HeaderProps) => {
  ...
  return (
    ...
    >
      <div className='mx-auto flex w-[100%] items-center justify-between px-6 py-1'>
        <Link href='/'>
          <div className='flex items-center justify-center no-underline'>
            <Image
              ...
              width={120}
              height={120}
              className='h-auto w-[140px] md:w-[120px]'
            />
          </div>
        </Link>
        <div className='flex items-center gap-10 md:gap-5'>
          <Link
            href='/'
            className={`text-[0.85rem] leading-5 font-[var(--font-gilroy)] font-medium no-underline transition-colors duration-200 ${
              pathname === '/'
            ...
            <div className='flex items-center justify-center'>
              <Popover open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
                <PopoverTrigger asChild>
                  <button
                    className='flex h-5 w-5 cursor-pointer items-center justify-center overflow-hidden rounded-full bg-gray-100 text-gray-900 no-underline transition-all duration-200 hover:scale-105 hover:bg-gray-200'
                ...
                >
                  <div className='flex flex-col gap-1'>
                    <button
                      ...
                      className='flex w-full cursor-pointer items-center gap-3 rounded border-none bg-transparent p-2.5 text-left text-[0.85rem] font-[var(--font-gilroy)] font-medium text-gray-900 transition-all duration-200 hover:bg-gray-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-500 md:gap-3 md:p-2 md:text-[13px]'
