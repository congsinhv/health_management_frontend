...
const UserInfoSection: React.FC<UserInfoSectionProps> = ({ data }) => {
  return (
    <div className='space-y-6'>
      ...
      <div className='rounded-xl border-2 border-[#EFEFEF]'>
        <h3 className='border-b-2 border-[#EFEFEF] px-4 py-3 text-xs font-semibold text-gray-900'>
      ...
      <div className='rounded-xl border-2 border-[#EFEFEF]'>
        ...
        <div className='space-y-2 p-4'>
          ...
          />
          <InfoRow
            label='Số bữa ăn chính mỗi ngày'
            value={`${data.mainMeals} bữa/ngày`}
          />
          <InfoRow
            label='Có ăn vặt xen giữa các bữa ăn chính không?'
            value={data.snackFrequency}
          />
        </div>
      </div>
      ...
      <div className='rounded-xl border-2 border-[#EFEFEF]'>
        ...
        <div className='space-y-2 p-4'>
          ...
          />
          <InfoRow
            label='Mức độ sử dụng thiết bị điện tử/ngày'
...
const InfoRow: React.FC<InfoRowProps> = ({ label, value }) => {
  return (
    <div className='flex items-start justify-between py-1'>
      <span className='w-1/2 flex-shrink-0 text-xs text-gray-600'>
        {label}:
      </span>
